...
class RegisterPage extends StatelessWidget {
  ...
  PreferredSizeWidget _renderAppBar(BuildContext context) => AppBar(
      ...
      leading: IconButton(
          ...
          onPressed: () => context
              .read<RegisterBloc>()
              .add(RegisterEventNavigateTo('/login'))),
  ...
  Widget _body(BuildContext context, RegisterState state) {
    ...
    return Stack(
      children: [
        ...
        if (state is RegisterStateInitial || state is RegisterStateLoading)
  ...
  Widget _registerStreamBuilder(BuildContext builderContext) =>
      StreamBuilder<bool>(
        ...
        Form(
          ...
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Container(child: _createRegisterFields(context)),
            ),
          ),
        ),
      ],
            ...
            child: Padding(
              ...
              child: DropdownComponent(
                model: DropdownComponentModel(
                  dropDownLists: context
                      .read<RegisterBloc>()
                      .genresList
                      .map((e) => e)
                      .toList(),
                  itemDropdownSelected:
                      context.read<RegisterBloc>().genreSelected!,
                ),
                didChangeValue: (newValue) =>
                    context.read<RegisterBloc>().genreSelected = newValue,
              ),
            ))
      ],
    );
            ...
            child: DropdownComponent(
              model: DropdownComponentModel(
                dropDownLists: context
                    ...
                    .toList(),
                itemDropdownSelected:
                    context.read<RegisterBloc>().phoneSelected!,
              ),
              didChangeValue: (newValue) =>
                  context.read<RegisterBloc>().phoneSelected = newValue,
            ),
          ),
        ),
        Expanded(
  ...
  Widget _renderPatientBirthDateFields(BuildContext context) {
    ...
    _textBirthdayController.text = spaces +
        DateFormat('yyyy-MM-dd').format(context.read<RegisterBloc>().birthDate);
        ...
        Expanded(
          ...
          child: IconButton(
            ...
            onPressed: () async {
              ...
              if (newDate != null)
                context.read<RegisterBloc>().birthDate = newDate;
            },
          ),
        ),
      ],
    ...
    return Row(
      ...
      children: [
        Checkbox(
          ...
          onChanged: (value) =>
              context.read<RegisterBloc>().termsAndConditionsSelected = value!,
        ),

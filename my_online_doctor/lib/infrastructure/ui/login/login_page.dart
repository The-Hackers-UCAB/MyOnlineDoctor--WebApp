...
class LoginPage extends StatelessWidget {
  ...
  final TextEditingController _textEmailController =
      TextEditingController(text: 'doctor@email.com');
  ...
  Widget _body(BuildContext context, LoginState state) {
    ...
    return Stack(
      children: [
        ...
        if (state is LoginStateInitial || state is LoginStateLoading)
  ...
  Widget _loginStreamBuilder(BuildContext builderContext) =>
      StreamBuilder<bool>(
...
//Widget to create the fields
  ...
  Widget _renderRegisterButton(BuildContext context) => Container(
      ...
      child: ButtonComponent(
        ...
        actionButton: () =>
            context.read<LoginBloc>().add(LoginEventNavigateTo('/register')),
      ));
  ...
  void _signIn(BuildContext context) {
    ...
    context.read<LoginBloc>().add(LoginEventLoginPatient(
        signInPatientDomainModel, _formKey.currentState?.validate() ?? false));
  }
}

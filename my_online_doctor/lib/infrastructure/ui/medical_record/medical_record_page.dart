...
class MedicalRecordPage extends StatelessWidget {
  ...
  final TextEditingController _textDiagnosticController = TextEditingController();
  ...
  final TextEditingController _textAppointmentDateController = TextEditingController();
          ...
          Form(
            ...
            child: Center(
              child: SingleChildScrollView(
                ...
                child: Container(
                  child: _createMedicalRecordFields(context)
                ),
              ),
            ),
          ),
